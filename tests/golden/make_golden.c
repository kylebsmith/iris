...
int main(int argc, char **argv) {
  ...
  {
    int rc = write_pair(1, "tests/golden/v1-instrument.bin", "tests/golden/v1-expected.txt");
    if (rc) return rc;
    return write_pair(0, "tests/golden/v3-instrument.bin", "tests/golden/v3-expected.txt");
  }
}
